...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cliente1 = new Cliente(null, "Maria Silva", "leonardoanschau@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cliente1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cliente2 = new Cliente(null, "Ana Costa", "java.sender.mail@gmail.com", "38351166499",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		...
		Endereco endereco2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cliente1,
				cidade2);
		Endereco endereco3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "28777012", cliente2,
				cidade2);
